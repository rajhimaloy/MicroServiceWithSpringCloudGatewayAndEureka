package com.microservice.erp.controller.rest;
...
@Aspect
@Component
public class RestPerformanceAOP {

    private static Logger LOG = LoggerFactory.getLogger(RestPerformanceAOP.class);

    @Around("execution(* com.microservice.erp.controller.rest..*(..))")
